...
-- Función para calcular auxilio de transporte
DELIMITER //
...
-- Función para calcular aporte de seguridad social
DELIMITER //
...
-- Procedimiento para obtener los cargos de los empleados
DELIMITER //
...
-- Procedimiento para crear un contrato
DELIMITER //
...
BEGIN
    DECLARE v_id_seguridad_social INT;

    -- Crear registro de seguridad social
    INSERT INTO Seguridad_Social (id_empleado)
    ...
    INSERT INTO Contrato (
        salario_bruto, tipo, horario,
        fecha_inicio, fecha_fin,
        id_empleado, id_seguridad_social
    )
    VALUES (
        p_salario_bruto, p_tipo, p_horario,
        p_fecha_inicio, p_fecha_fin,
        p_id_empleado, v_id_seguridad_social
    );
END;
//
DELIMITER ;

-- Procedimiento para calcular nómina vacacional
DELIMITER //
...
-- Procedimiento para calcular nómina vacacional masiva
DELIMITER //
...
-- Procedimiento para calcular cesantías
DELIMITER //
...
-- Procedimiento para calcular seguridad social
DELIMITER //
...
CREATE OR REPLACE VIEW vista_impuestos_deducciones AS
SELECT
    e.id_empleado,
    e.nombre,
    e.cargo,
